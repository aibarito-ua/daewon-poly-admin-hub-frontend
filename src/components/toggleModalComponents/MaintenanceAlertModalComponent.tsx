    ...
    <div className='flex'>
      ...
      >
        <DialogTitle sx={{
            ...
            textAlign: 'center',
            height: '70px',
        }}><span className='maintenance-modal-title'>{maintenanceData.alertTitle}</span></DialogTitle>
        <DialogContent 
        ...
        <div className='flex flex-1 flex-col h-full justify-center mt-[36px] mb-[30px]'>
            <div className={''}>
                {maintenanceData.data.maintenance_description_en.map((msg, msgIdx)=>{
        ...
        >
          <div className='flex bg-[#ebf1f8] w-full h-[86px] pt-[15px] rounded-[10px] justify-center items-center relative'>
            <span className='maintenance-modal-time-message'>{maintenanceData.data.time_description_en}</span>
            <span className='absolute top-[-15px] flex w-[500px] justify-center'>
              <span className='maintenance-modal-time-title'>{'Maintenance Hours'}</span>
            </span>
          </div>
        </DialogActions>
      </Dialog>
