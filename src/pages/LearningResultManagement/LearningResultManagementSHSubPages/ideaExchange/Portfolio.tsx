        ...
        for (let row = 0; row < rsp.students.length; row++) {
            ...
            for (let col = 0; col < rowKeys.length; col++) {
                ...
                if (col===0) {
                    ...
                    rowData.push(makeCellData)
                } else if ((col - 2) % number_of_questions != (number_of_questions - 1)){
                    // question data
                    const makeCellData:TLRMSpeakingHubTableCellData = {
                        key: rowKeys[col],
                        width: 60,
                        title: 'Idea Exchange Portfolio',
                        ...
                        value:{
                            ...
                            modalContent: <QuestionReportTable question={targetStudent.lessons[lessonNumber - 1].questions[(col - 2) % number_of_questions]}/>
                        },
                        rowspan: 1,
                        print:true,
                        dataIndex: [row,col]
                    ...
                    const makeCellData:TLRMSpeakingHubTableCellData = {
                        ...
                        value:{
                            ...
                            show: targetStudent.lessons[lessonNumber - 1].questions[number_of_questions - 1].is_completed,
                            jsxElem: <QuestionReportIcon className='learning-management-class-table-complete-question-icon'/>,
                            modalContent: <QuestionReportTable question={targetStudent.lessons[lessonNumber - 1].questions[number_of_questions - 1]} />
                        },
                        rowspan: 1,
                        print:true,
                        dataIndex: [row,col]
